...
![GA4 觀察較短時間點價值的指標](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230302200224.png)

由（圖一）指標顯示，主要可查看到消費者當下所帶來的價值，例如：消費者在特定網頁完成某個事件的次數，通常是作為觀察一個「較短時間點」下所帶來的價值。

## 二、長期的經營價值

![GA4 觀察較長時間點價值的指標](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230302200303.png)
...
![GA4 觀察消費者「從哪來」的維度](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230302200357.png)

由（圖三）可觀察到消費者主要是從哪裡來的，例如：消費者來自哪個國家或城市、消費者是由哪個來源媒介導進站。

## 二、在我們網站上做了什麼

![GA4 觀察消費者「在我們網站上做了什麼」的維度](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230302200436.png)

## 三、我們怎麼標記他們

![GA4 觀察「我們怎麼標記消費者」的維度](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230302200525.png)
